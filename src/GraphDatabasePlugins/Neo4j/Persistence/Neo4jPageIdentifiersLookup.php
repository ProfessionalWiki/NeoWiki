...
class Neo4jPageIdentifiersLookup implements PageIdentifiersLookup {
	...
	/**
	 * Pages are reached by traversing HasSubject from globally-unique Subject ids, which is why the
	 * traversal is not wiki-scoped. Subject nodes are merged on id alone and detached per page, so
	 * more than one page can hold a HasSubject edge to the same Subject; which of them a Subject id
	 * then resolves to is unspecified.
	 *
