...
// Open Subjects the walk cannot reach: past its depth cap, unlinked from the form after being
// opened, or orphaned by a schema edit. Each is one the user has to be able to get back to.
