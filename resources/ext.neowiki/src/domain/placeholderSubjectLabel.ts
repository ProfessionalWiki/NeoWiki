 ...
 * Subject shows its Schema name, since the page name would give all of them the same
 * misleading name. The UI marks that case as a stand-in; see
 * presentation/subjectDisplayName.ts, which is where the marker is composed.
 */
