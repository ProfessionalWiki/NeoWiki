...
* The current `Neo4jReadQueryEngine` interface, `Neo4jWriteQueryEngine` class, and `Neo4jProjectionStore` remain as the
  Neo4j plugin. They do not need to be generalized into a shared abstraction for all backends.
