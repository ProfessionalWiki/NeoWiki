...
[`relation-target-unresolvable-source`](#relation-target-unresolvable-source) rejects a write either
way, because it reports a reference nothing can resolve rather than data failing a Schema rule.
