...
emitted, carrying the Subject's [`displayName`](subject-format.md#reading-subjects). Each Statement adds triples whose
predicate is the property's `neo-prop:` IRI, one per part of a multi-part Value.
